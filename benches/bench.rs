...
static NFL_WHITESPACE: &'static str = include_str!("../examples/data/bench/nfl_with_trimmable_whitespace.csv");
...
bench_trimmed!(count_nfl_iter_bytes_trimmed_whitespace, NFL_WHITESPACE, count_iter_bytes, 130000);
