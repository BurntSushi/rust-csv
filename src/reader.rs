...
impl<R: io::Reader, D: Decodable<Decoded, Error>> Iterator<CsvResult<D>>
    for DecodedRecords<R, D> {
...
impl<R: io::Reader> Iterator<CsvResult<Vec<String>>> for StringRecords<R> {
...
impl<R: io::Reader> Iterator<CsvResult<Vec<ByteString>>> for ByteRecords<R> {
